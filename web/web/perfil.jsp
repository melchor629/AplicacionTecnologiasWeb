            ...
            <div class="col-sm-4 col-md-3 profile-info-section">
                ...
                <div class="profile-options">
                    ...
                    <% } else {
                        ...
                        if (amigos) {%>
                    <a href="<%= cpath%>/PeticionAmistadServlet?accion=2&id=<%= u.getId()%>" class="btn btn-primary btn-raised">
                        <i class="fa fa-user-times"></i> Eliminar amistad
                    </a>
                    <% } else {%>

                    <% if (!peticionEnviada) {%>
                    <a href="<%= cpath%>/PeticionAmistadServlet?accion=1&id=<%= u.getId()%>" class="btn btn-primary btn-raised">
